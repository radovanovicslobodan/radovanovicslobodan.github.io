    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          ...
          <Subtitle>Aspiring QA Tester and Web Developer from Belgrade, Serbia.</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          ...
          <AboutDesc>
            I have technical skills as well as interpersonal skills, enabling me to interact with a wide range of people. I am eager to be challenged in order to grow and further improve my IT skills. My greatest passion in life is using my technical know-how to benefit other people and organisations.
          </AboutDesc>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          <Title>Contact</Title>
          <ContactText>
            Say <a href="mailto:r.slobodan75@gmail.com">Hi</a> or find me on other places:{' '}
            <a target="_blank" rel="noopener noreferrer" href="https://github.com/radovanovicslobodan">GitHub</a> &{' '}
            <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/slobodan-radovanovic-080977165/">LinkedIn</a>
          </ContactText>
        </Inner>
        <Footer>
          &copy; 2019 by Slobodan Radovanovic.
        </Footer>
      </Content>
